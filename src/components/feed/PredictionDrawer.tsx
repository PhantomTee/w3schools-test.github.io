...
export function PredictionDrawer({
  ...
  // Build pool map from pools array
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedRange === i
                        ? 'border-[var(--border-active)] bg-[var(--blue-primary)]/[0.08]'
                        : 'border-[var(--border-soft)] bg-[var(--bg-elevated)] hover:border-[rgba(59,130,246,0.25)]'
                    )}
                  >
                    <span className="text-[13px] font-medium text-[var(--text-primary)]">{r.label}</span>
                    <div className="flex items-center gap-2 text-[12px]">
                      {selectedRange === i && (
                        <span className="text-[10px] text-[var(--blue-bright)] font-medium">Selected</span>
                      )}
                      ...
                      <span className={cn(
                        ...
                        selectedRange === i ? 'text-[var(--blue-bright)]' : 'text-[var(--text-secondary)]'
                      )}>
              ...
              {STAKE_PRESETS.map(p => (
                <button
                  ...
                  className={cn(
                    ...
                    stake === p && !customStake
                      ? 'border-[var(--border-active)] bg-[var(--blue-primary)]/[0.10] text-[var(--blue-bright)]'
                      : 'border-[var(--border-soft)] bg-[var(--bg-elevated)] text-[var(--text-secondary)] hover:border-[rgba(59,130,246,0.25)]'
                  )}
                >
                  {p} USDC
                </button>
              ...
              <input
                ...
                className={cn(
                  ...
                  customStake
                    ...
                    : 'border-[var(--border-soft)] focus:border-[rgba(59,130,246,0.45)]'
                )}
              />
            </div>
          </div>
  ...
  return (
    <div className="flex justify-between items-baseline">
      ...
      <span className={cn(
        ...
        highlight ? 'text-[var(--blue-bright)]' : 'text-[var(--text-primary)]'
      )}>{value}</span>
    </div>
  )
}
